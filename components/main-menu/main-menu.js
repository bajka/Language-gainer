...
export default class MainMenu extends React.Component {
    ...
    render() {
        return <View style={styles.menuContainer}>
            ...
            <MenuButton headerText='Deep dive into language' description='Listen podcast and read texts in chosen language' image={Images.diving} click={this.openPodcastsList} disabled={true}></MenuButton>
